...
export const getPostApiAuthSignupResponseMock = (
  overrideResponse: Partial<SignUpResponse | SignUpResponse> = {}
  ...
  faker.helpers.arrayElement([
    {
      user: {
        ...
        githubUsername: faker.helpers.arrayElement([
      ...
      alreadyExists: faker.helpers.arrayElement([
...
export const getGetApiUsersProfileResponseMock = (
...
export const getGetApiUsersSettingsResponseMock = (
  overrideResponse: Partial<UserSettingsResponse> = {}
): UserSettingsResponse => ({
  user: {
    id: faker.string.uuid(),
    email: faker.internet.email(),
...
export const getPutApiUsersSettingsResponseMock = (
  overrideResponse: Partial<UserSettingsResponse> = {}
): UserSettingsResponse => ({
  user: {
    id: faker.string.uuid(),
...
export const getGetApiDataSourcesResponseMock = (
  overrideResponse: Partial<DataSourceListResponse> = {}
): DataSourceListResponse => ({
  ...
  data: {
    items: Array.from(
      ...
      repository: {
        ...{
          id: faker.string.alpha({ length: { min: 10, max: 20 } }),
          dataSourceId: faker.string.alpha({ length: { min: 10, max: 20 } }),
          githubId: faker.number.float({
            min: undefined,
            max: undefined,
            fractionDigits: 2,
          }),
          ...
          starsCount: faker.number.float({
            min: undefined,
            max: undefined,
            fractionDigits: 2,
          }),
          forksCount: faker.number.float({
            min: undefined,
            max: undefined,
            fractionDigits: 2,
          }),
          openIssuesCount: faker.number.float({
            min: undefined,
            max: undefined,
            fractionDigits: 2,
          }),
      ...
      userWatch: {
        ...
        watchReleases: faker.datatype.boolean(),
        watchIssues: faker.datatype.boolean(),
        watchPullRequests: faker.datatype.boolean(),
        addedAt: faker.string.alpha({ length: { min: 10, max: 20 } }),
      },
    })),
    pagination: {
...
export const getPostApiDataSourcesResponseMock = (
  overrideResponse: Partial<CreateDataSourceResponse> = {}
): CreateDataSourceResponse => ({
  success: faker.datatype.boolean(),
  data: {
    dataSource: {
...
export const getGetApiDataSourcesIdResponseMock = (
  overrideResponse: Partial<DataSourceDetailResponse> = {}
): DataSourceDetailResponse => ({
  success: faker.datatype.boolean(),
  data: {
    dataSource: {
...
export const getPutApiDataSourcesIdResponseMock = (
  overrideResponse: Partial<PutApiDataSourcesId200> = {}
): PutApiDataSourcesId200 => ({
  success: faker.datatype.boolean(),
  data: {
    dataSource: {
...
export const getGetApiUsersProfileMockHandler = (
  overrideResponse?:
    | UserProfileResponse
    | ((
...
export const getPutApiUsersProfileMockHandler = (
  overrideResponse?:
    | UserProfileResponse
    | ((
...
export const getGetApiUsersSettingsMockHandler = (
  overrideResponse?:
    | UserSettingsResponse
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0]
...
export const getPutApiUsersSettingsMockHandler = (
  overrideResponse?:
    | UserSettingsResponse
    | ((
        info: Parameters<Parameters<typeof http.put>[1]>[0]
...
export const getGetApiDataSourcesMockHandler = (
  overrideResponse?:
    | DataSourceListResponse
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0]
      ) => Promise<DataSourceListResponse> | DataSourceListResponse)
) => {
...
export const getPostApiDataSourcesMockHandler = (
  overrideResponse?:
    | CreateDataSourceResponse
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0]
      ) => Promise<CreateDataSourceResponse> | CreateDataSourceResponse)
) => {
...
export const getGetApiDataSourcesIdMockHandler = (
  overrideResponse?:
    | DataSourceDetailResponse
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0]
      ) => Promise<DataSourceDetailResponse> | DataSourceDetailResponse)
) => {
...
export const getPutApiDataSourcesIdMockHandler = (
  overrideResponse?:
    | PutApiDataSourcesId200
    | ((
        info: Parameters<Parameters<typeof http.put>[1]>[0]
      ) => Promise<PutApiDataSourcesId200> | PutApiDataSourcesId200)
) => {
...
export const getDeleteApiDataSourcesIdMockHandler = (
  overrideResponse?:
    | null
    | ((
