...
export const getGetApiProfileUrl = () => {
  ...
  return `http://localhost:3001/api/profile`
}
...
export const getGetApiActivitiesUrl = (params?: GetApiActivitiesParams,) => {
  ...
  return stringifiedParams.length > 0 ? `http://localhost:3001/api/activities?${stringifiedParams}` : `http://localhost:3001/api/activities`
}
...
export const getGetApiActivitiesActivityIdUrl = (activityId: string,) => {
  ...
  return `http://localhost:3001/api/activities/${activityId}`
}
...
export const getGetApiDataSourcesDataSourceIdActivitiesUrl = (dataSourceId: string,
  ...
  return stringifiedParams.length > 0 ? `http://localhost:3001/api/data-sources/${dataSourceId}/activities?${stringifiedParams}` : `http://localhost:3001/api/data-sources/${dataSourceId}/activities`
}
...
export const getGetApiNotificationsUrl = (params?: GetApiNotificationsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `http://localhost:3001/api/notifications?${stringifiedParams}` : `http://localhost:3001/api/notifications`
}
...
export const getGetApiNotificationsNotificationIdUrl = (notificationId: string,) => {
  ...
  return `http://localhost:3001/api/notifications/${notificationId}`
}
